...
public class Mediocampista extends Jugador implements FicharJugador {
    int golesConvertidos,asistenciasRealizadas;

    public Mediocampista(String nombre, fecha fechaDeNacimiento, Provincia provincia, int numeroDeCamiseta, HashSet<Club> equiposPorLosQuePaso, int golesConvertidos, int asistenciasRealizadas) {
