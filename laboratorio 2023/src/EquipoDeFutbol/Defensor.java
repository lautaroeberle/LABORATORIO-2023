...
public class Defensor extends Jugador implements FicharJugador{
    int golesConvertidos,asistenciasRealizadas;

    public Defensor(String nombre, fecha fechaDeNacimiento, Provincia provincia, int numeroDeCamiseta, HashSet<Club> equiposPorLosQuePaso, int golesConvertidos, int asistenciasRealizadas) {
